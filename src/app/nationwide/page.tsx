...
const cityCards = [
  ...
  {
    name: 'San Diego',
    image: 'https://images.unsplash.com/photo-1508402476522-c77c2fa4479d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
    link: '/reservation',
  ...
  {
    name: 'Chicago',
    image: 'https://images.unsplash.com/photo-1494522355075-2c0ab7b3e7b9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
    link: '/reservation',
  ...
  {
    name: 'Miami',
    image: 'https://images.unsplash.com/photo-1514214246283-d427a95c5d2f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2073&q=80',
    link: '/reservation',
    ...
    <div className="min-h-screen bg-black text-gray-100">
            ...
            {cities.map((city) => (
              ...
              >
                <span className="text-yellow-500">
                  <svg width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#FACC15"/><path d="M7 13l3 3 7-7" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </span>
                <span className="text-lg font-medium text-yellow-100">{city}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            Whether you&apos;re attending a business conference, celebrating a graduation, heading off on a much needed vacation or just spending a special night in the city, Cheery Limousine&apos;s limo service will promptly attend to all your travel needs.
          </motion.p>
          <motion.div 
            className="space-y-6"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <motion.div
              whileHover={{ scale: 1.05 }}
            >
              <Link href="/about" className="inline-block px-6 py-3 bg-black text-yellow-500 font-bold rounded-lg hover:bg-gray-900 transition">
              ...
              >
                <div className="relative h-64 w-full">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="text-3xl font-bold text-yellow-500">{card.name}</h3>
                    <p className="text-gray-200 mt-2">Premium limousine service</p>
                  </div>
                </div>
                <div className="flex-1 flex items-end p-6">
                  <Link href={card.link} className="w-full text-center rounded-lg bg-yellow-600 px-6 py-3 text-lg font-bold text-black transition hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:ring-offset-black">
                    Book Now
                  </Link>
                </div>
              </motion.div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            {[
              {
                quote: "Cheery Limousine provided exceptional service for our corporate event in New York. The chauffeur was professional and the vehicle was immaculate.",
                author: "Michael T., New York",
                rating: "★★★★★"
              },
              {
                quote: "Used their service in Miami for our wedding. Everything was perfect - on time, clean, and the driver went above and beyond to make our day special.",
              ...
              >
                <div className="flex items-center mb-4">
                  <div className="text-yellow-500 text-2xl mr-2">{testimonial.rating}</div>
                </div>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <motion.p 
            ...
            transition={{ delay: 0.4 }}
          >
            Book your luxury transportation today and discover why we&apos;re the preferred choice for discerning clients across the country.
          </motion.p>
          <motion.div
