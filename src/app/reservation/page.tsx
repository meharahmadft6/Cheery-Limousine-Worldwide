          ...
          {isSuccess ? (
            <div className="bg-yellow-500/10 border border-yellow-500 rounded-xl p-8 text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg mb-6">
                Thank you for choosing Cherry Limousine Worldwide. Our team will
                ...
                <div className="p-8">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className={`w-full bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-4 px-6 rounded-lg transition-all duration-300 ${
