    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-32 pb-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Avoid parking hassles and arrive in style at Bay Area venues. We&#39;ll get you there and back safely.
            </p>
          </div>
          ...
          <div className="relative w-full h-64 md:h-96 lg:h-[500px] rounded-xl overflow-hidden mb-12 shadow-xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 text-white hidden md:block">
              ...
              <p className="text-gray-300 max-w-2xl">
                Our service ensures you enjoy the event without worrying about parking, traffic, or designated drivers.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6 text-gray-300">
                <p>
                  Attending concerts, sports games, or special events in the Bay Area should be about the experience, not the logistics. Our event transportation service handles all the details so you can focus on enjoying the show.
                </p>
                <p>
                  We specialize in group transportation to all major venues including Chase Center, Oracle Park, Levi&#39;s Stadium, and the Greek Theatre. Our drivers know the best routes and pickup locations to avoid traffic congestion.
                </p>
                <p>
                  With late-night availability and group pricing options, we make it easy and affordable for your whole party to travel together safely. Arrive relaxed and leave without the parking lot scramble.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-white">Late Night Service</h4>
                    <p className="text-gray-400 text-sm">Available until the last guest leaves the venue</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-yellow-500/10 p-2 rounded-lg mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Special pricing for parties of 6 or more</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-yellow-500/10 p-2 rounded-lg mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Designated pickup points at all major venues</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-yellow-500/10 p-2 rounded-lg mr-4">
                  ...
                  <div>
                    <h4 className="font-medium text-white">Celebration Ready</h4>
                    <p className="text-gray-400 text-sm">Optional party lighting and sound systems</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            {[
              {
                ...
                description: "Celebrate in style with lighting and premium sound",
                capacity: "8-10 passengers",
                image: "/limo7.jpg"
              },
              {
                name: "Luxury Party Bus",
                description: "Spacious ride for large groups with entertainment",
        ...
        <section className="text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Book Your Event Transportation Today</h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            Make your next event experience seamless and memorable with our professional transportation.
          </p>
