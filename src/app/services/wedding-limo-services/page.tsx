      ...
      <main className="pt-32 pb-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              From the ceremony to the reception, our wedding packages provide
              flawless transportation for the entire bridal party.
            </p>
          </div>
          ...
          <div className="relative w-full h-64 md:h-96 lg:h-[500px] rounded-xl overflow-hidden mb-12 shadow-xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 text-white hidden md:block">
              ...
              <p className="text-gray-300 max-w-2xl">
                Our luxury fleet and professional chauffeurs ensure your wedding
                transportation is seamless and stress-free.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6 text-gray-300">
                <p>
                  Your wedding day should be perfect in every detail. Our
                  wedding limousine service provides elegant, reliable
                  transportation that complements your special occasion. We
                  coordinate with your wedding planner to ensure flawless timing
                  from the ceremony to the reception.
                </p>
                <p>
                  Whether you need transportation for the bridal party, family
                  members, or the entire wedding guest list, our fleet of luxury
                  vehicles can accommodate groups of all sizes. We specialize in
                  creating memorable experiences with our attention to detail
                  and white-glove service.
                </p>
                <p>
                  From classic stretch limousines to modern luxury SUVs, we
                  offer a variety of vehicles to match your wedding theme and
                  style. Our packages include special touches like complimentary
                  champagne and &quot;Just Married&quot; decorations.
                </p>
              </div>
            </div>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Spacious interiors for last-minute touch-ups
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Custom &quot;Just Married&quot; signs and ribbons
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Precision scheduling with your wedding planner
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Toast to your new life together in style
                    </p>
                  </div>
                </li>
              </ul>
            ...
            {[
              {
                ...
                description:
                  "Timeless elegance for the bridal party's grand entrance",
              ...
              },
              {
                ...
                description:
                  "Modern sophistication for wedding party transportation",
              ...
              },
              {
                ...
                description:
                  "Old-world charm for a fairy tale wedding experience",
        ...
        <section className="mb-20 bg-gradient-to-r from-yellow-900/30 to-black/50 p-8 rounded-2xl border border-yellow-500/20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <blockquote className="text-xl italic text-white mb-6">
              &quot;Cherry Limousine made our wedding day transportation
              absolutely perfect! From getting ready at the hotel to our grand
              exit from the reception, everything was seamless. Our chauffeur
              even helped coordinate timing with our photographer. The vintage
              Rolls Royce was stunning and made us feel like royalty!&quot;
            </blockquote>
        ...
        <section className="text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            Contact us today to discuss your wedding transportation needs and
