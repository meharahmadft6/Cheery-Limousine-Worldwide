      ...
      <main className="pt-32 pb-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Sip in style with our Napa/Sonoma wine tour packages. Travel
              safely between vineyards in luxury vehicles with knowledgeable
              drivers.
            </p>
          </div>
          ...
          <div className="relative w-full h-64 md:h-96 lg:h-[500px] rounded-xl overflow-hidden mb-12 shadow-xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 text-white hidden md:block">
              ...
              <p className="text-gray-300 max-w-2xl">
                Our professional drivers know the best routes and vineyards to
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6 text-gray-300">
                <p>
                  Discover California&#39;s world-famous wine regions without
                  the hassle of driving. Our wine tour service provides
                  comfortable, safe transportation between the finest vineyards
                  in Napa and Sonoma Valleys.
                </p>
                <p>
                  We specialize in creating customized itineraries based on your
                  wine preferences, whether you&#39;re looking for bold
                  Cabernets, buttery Chardonnays, or hidden-gem boutique
                  wineries. Our drivers are knowledgeable about the region and
                  can recommend the perfect stops for your group.
                </p>
                <p>
                  With spacious vehicles equipped with cooler storage, you can
                  safely transport your wine purchases while continuing your
                  tasting journey in comfort. We&#39;ll handle all the logistics
                  so you can focus on the flavors.
                </p>
              </div>
            </div>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Personalized route planning based on your wine preferences
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Temperature-controlled storage for your purchases
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Expert recommendations for vineyards and tasting rooms
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Half-day, full-day, and multi-day tour options available
                    </p>
                  </div>
                </li>
              </ul>
            ...
            {[
              {
                name: "Luxury SUV",
                description:
                  "Comfortable transportation for small groups with ample storage",
              ...
              },
              {
                name: "Executive Van",
                description:
                  "Spacious ride for larger groups with wine storage",
        ...
        <section className="mb-20 bg-gradient-to-r from-yellow-900/30 to-black/50 p-8 rounded-2xl border border-yellow-500/20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <blockquote className="text-xl italic text-white mb-6">
              &quot;Our Napa wine tour with Cherry Limousine was absolutely
              perfect! The driver knew all the best small vineyards we would
              have never found on our own. The SUV had plenty of space for our
              group and all our wine purchases. We never worried about drinking
              and driving - just pure enjoyment!&quot;
            </blockquote>
        ...
        <section className="text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            Let us handle the driving while you enjoy the finest wines Northern
