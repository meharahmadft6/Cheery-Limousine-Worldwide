    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-32 pb-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Make your prom night unforgettable with our luxury fleet. Safe, stylish rides with red carpet treatment for your special night.
            </p>
          </div>
          ...
          <div className="relative w-full h-64 md:h-96 lg:h-[500px] rounded-xl overflow-hidden mb-12 shadow-xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 text-white hidden md:block">
              ...
              <p className="text-gray-300 max-w-2xl">
                Arrive in style and make memories that will last a lifetime with our premium prom packages.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6 text-gray-300">
                <p>
                  Your prom night should be nothing short of magical. Our prom limo service provides the perfect transportation solution for students looking to make a grand entrance and enjoy a safe, luxurious ride throughout the evening.
                </p>
                <p>
                  We specialize in creating unforgettable experiences for prom groups throughout the Bay Area. Our professional chauffeurs are trained to provide exceptional service while maintaining the highest safety standards for student transportation.
                </p>
                <p>
                  Whether you&#39;re planning an intimate ride for a couple or need accommodations for your entire friend group, we offer vehicles to suit every prom night need.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-white">LED Mood Lighting</h4>
                    <p className="text-gray-400 text-sm">Customizable interior lighting to set the perfect atmosphere</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-yellow-500/10 p-2 rounded-lg mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Non-alcoholic sparkling cider celebration (upon request)</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-yellow-500/10 p-2 rounded-lg mr-4">
                  ...
                  <div>
                    <h4 className="font-medium text-white">Complimentary Bottled Water</h4>
                    <p className="text-gray-400 text-sm">Stay refreshed throughout your special night</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-yellow-500/10 p-2 rounded-lg mr-4">
                  ...
                  <div>
                    <h4 className="font-medium text-white">Red Carpet Service</h4>
                    <p className="text-gray-400 text-sm">Optional red carpet rollout for your grand arrival</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            {[
              {
                ...
                description: "The ultimate prom experience with ample space for your group",
                capacity: "8-10 passengers",
                image: "/stretch.jpeg"
              },
              {
                name: "SUV Limousine",
                description: "Modern luxury with extra headroom and premium features",
        ...
        <section className="text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Ready to Book Your Prom Ride?</h2>
