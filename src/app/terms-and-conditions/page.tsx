        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.p className="mb-6" variants={fadeIn}>
              ...
              voluntarily provide it through our reservation forms or 
              contact requests. The information we may collect includes:
            </motion.p>
            <motion.ul className="mb-6 space-y-2" variants={fadeIn}>
              ...
              <li>Payment information (processed securely through encrypted servers)</li>
            </motion.ul>
            ...
            <motion.ul className="mb-6 space-y-2" variants={fadeIn}>
              ...
              <li>We do not store complete credit card details after processing</li>
            </motion.ul>
            ...
            <motion.p className="mb-6" variants={fadeIn}>
              ...
              parties except when necessary for service provision or as 
              required by law. This may include:
            </motion.p>
            <motion.ul className="mb-6 space-y-2" variants={fadeIn}>
              <li>Payment processors for transaction completion</li>
              <li>Affiliate transportation providers for service fulfillment</li>
