...
const heroSlides = [
  {
    ...
    subtitle: "Bay Area",
    description:
      "Experience unmatched luxury and professionalism with our premium limo service SF Bay Area, trusted by executives and CEOs.",
  ...
  },
  {
    ...
    description:
      "Spacious, group-friendly party buses for celebrations and special occasions. Perfect for weddings, proms, and corporate events.",
  ...
  },
  {
    ...
    description:
      "Reliable, discreet black car rides for business or private transportation. Your trusted partner for executive travel.",
  ...
  },
  {
    ...
    description:
      "Elegant transportation for couples, families, and bridal parties on your wedding day.",
    badge: "Wedding Limo",
  },
  {
    id: 6,
    ...
    description:
      "Luxury transportation for unforgettable wine country tours in comfort and style.",
    badge: "Wine Tour",
  },
  {
    id: 7,
    ...
    description:
      "Timely, stress-free airport drop-offs and pickups with professional chauffeurs.",
  ...
  },
  {
    ...
    description:
      "Explore San Francisco and nearby attractions with personalized city tour limo service.",
    badge: "City Tours",
  },
  {
    id: 9,
    ...
    description:
      "Elegant limo service to celebrate your daughter's special Quinceañera day.",
          ...
          >
            ...
            <div className="relative z-10 h-full container mx-auto md:ml-10 md:mr-5 px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
              ...
              <div className="lg:w-1/2 text-center lg:text-left py-20 lg:py-0 lg:pr-10 flex flex-col justify-center min-h-screen lg:min-h-0">
                ...
                <h1
                  className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 lg:mb-6 transition-all duration-1000 delay-400 leading-tight ${
                    isVisible
                ...
                <p
                  className={`hidden lg:block text-lg sm:text-xl lg:text-2xl mb-8 max-w-2xl mx-auto lg:mx-0 text-gray-200 transition-all duration-1000 delay-600 ${
                    isVisible
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-8"
                  }`}
