      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex space-x-4 mb-6">
              <a href="#" className="w-10 h-10 bg-yellow-500 rounded-full flex items-center justify-center hover:bg-yellow-400 transition-colors duration-300">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-yellow-500 font-bold text-lg">ALL BAY LIMOUSINE</span>
            </div>
          </div>
          ...
          <div className={`transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-300">+1 (415) 877-1899</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">info@allbaylimo.com</span>
              </div>
              
              <div className="flex items-start">
                <svg className="w-5 h-5 text-yellow-500 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`border-t border-gray-800 mt-12 pt-8 text-center transition-all duration-1000 delay-800 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <p className="text-gray-400">
            © 2025 All Bay Limo | All Right Reserved.
          </p>
        </div>
      </div>
    </footer>
