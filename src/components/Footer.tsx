          ...
          <div className={`transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <a href="tel:+14158771899" className="text-gray-300 hover:text-yellow-500 transition-colors duration-300">+1 (415) 877-1899</a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:info@cheerylimo.com" className="text-gray-300 hover:text-yellow-500 transition-colors duration-300">info@cheerylimo.com</a>
              </div>
